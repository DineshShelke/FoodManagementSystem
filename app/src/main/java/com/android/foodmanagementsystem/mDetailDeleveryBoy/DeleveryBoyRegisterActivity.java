...
public class DeleveryBoyRegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delevery_boy_register);
        ...
        myToolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(DeleveryBoyRegisterActivity.this,DeleveryBoyLoginActivity.class));
                finish();
            }
        });
        ...
        ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(DeleveryBoyRegisterActivity.this,
        ...
        mySpinnar.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                //Toast.makeText(DeleveryBoyRegisterActivity.this, mySpinnar.getSelectedItem().toString(), Toast.LENGTH_SHORT).show();
            }
    ...
    private void Register() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        Toast.makeText(DeleveryBoyRegisterActivity.this, response, Toast.LENGTH_SHORT).show();
                    }
                }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(DeleveryBoyRegisterActivity.this, error.toString(), Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
        ...
        Singleton.getInstance(DeleveryBoyRegisterActivity.this).addToRequestque(stringRequest);
