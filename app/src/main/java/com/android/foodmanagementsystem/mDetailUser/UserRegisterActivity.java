...
public class UserRegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myToolbar.setTitle(getResources().getString(R.string.user));
        ...
        ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(UserRegisterActivity.this,
        ...
        mySpinnar.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                //Toast.makeText(UserRegisterActivity.this, mySpinnar.getSelectedItem().toString(), Toast.LENGTH_SHORT).show();
            }
   ...
   /* @Override
    ...
    private void Register() {
        ...
        Singleton.getInstance(UserRegisterActivity.this).addToRequestque(stringRequest);
    }
