...
import com.android.foodmanagementsystem.BuildConfig;
 ...
 */
public class LatLangActivity extends AppCompatActivity implements OnMapReadyCallback{
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(LatLangActivity.this, REQUEST_CHECK_SETTINGS);
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                ...
                                Toast.makeText(LatLangActivity.this, errorMessage, Toast.LENGTH_LONG).show();
                                mRequestingLocationUpdates = false;
                        }
    ...
    private void updateLocationUI() {
        ...
        if (mCurrentLocation != null) {
            ...
            Toast.makeText(this, String.valueOf(mCurrentLocation.getLatitude())+":"+mCurrentLocation.getLongitude(), Toast.LENGTH_SHORT).show();
            ...
            showSnackbar(R.string.permission_rationale,
                    android.R.string.ok, new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            // Request permission
                            ActivityCompat.requestPermissions(LatLangActivity.this,
