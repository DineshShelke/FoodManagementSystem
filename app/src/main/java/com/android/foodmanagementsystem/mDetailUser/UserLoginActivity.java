...
public class UserLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        builder  = new AlertDialog.Builder(UserLoginActivity.this);
    ...
    public void Login(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                                ...
                                if (jo.getString("success").equals("Login Successfully")){
                                    ...
                                    builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            startActivity(new Intent(UserLoginActivity.this,HomeActivityUser.class));
                                            finish();
                                        }
                                    });
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(UserLoginActivity.this, error.toString(), Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
        ...
        Singleton.getInstance(UserLoginActivity.this).addToRequestque(stringRequest);
    }
