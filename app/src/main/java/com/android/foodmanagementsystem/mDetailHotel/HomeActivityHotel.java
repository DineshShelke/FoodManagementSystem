...
public class HomeActivityHotel extends AppCompatActivity {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (item.getItemId()== R.id.nav_item_draft) {
                    FragmentTransaction fragmentTransaction= FM.beginTransaction();
                    fragmentTransaction.replace(R.id.containerView, new DraftsFragment()).commit();
                }
                return false;
            }
        });
   ...
   /* @Override
    public void onBackPressed() {
        ...
        startActivity(new Intent(HomeActivityHotel.this, HotelLoginActivity.class));
        finish();
