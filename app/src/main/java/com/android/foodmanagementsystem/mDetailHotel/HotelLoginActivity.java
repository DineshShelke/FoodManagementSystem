...
public class HotelLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        builder  = new AlertDialog.Builder(HotelLoginActivity.this);
        ...
        myToolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(HotelLoginActivity.this, MainActivity.class));
                finish();
            }
        });
        ...
        signUp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(HotelLoginActivity.this, HotelRegisterActivity.class));
                finish();
            }
        });
    ...
    public void Login(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                       //Toast.makeText(HotelLoginActivity.this, "Suvi Response "+response, Toast.LENGTH_SHORT).show();
                                ...
                                if (jo.getString("success").equals("Login Successfully")){
                                    ...
                                    builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                           startActivity(new Intent(HotelLoginActivity.this,HomeActivityHotel.class));
                                           finish();
                                        }
                                    });
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(HotelLoginActivity.this, error.toString(), Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
        ...
        Singleton.getInstance(HotelLoginActivity.this).addToRequestque(stringRequest);
    }
