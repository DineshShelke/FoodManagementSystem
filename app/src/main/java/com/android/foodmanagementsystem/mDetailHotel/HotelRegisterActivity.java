...
import com.android.foodmanagementsystem.mDetailDeleveryBoy.DeleveryBoyLoginActivity;
...
public class HotelRegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myToolbar.setTitle(getResources().getString(R.string.hotel));
        ...
        myToolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(HotelRegisterActivity.this,HotelLoginActivity.class));
                finish();
            }
        });
        ...
        ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(HotelRegisterActivity.this,
        ...
        mySpinnar.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                //Toast.makeText(HotelRegisterActivity.this, mySpinnar.getSelectedItem().toString(), Toast.LENGTH_SHORT).show();
            }
    ...
    private void Register() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        Toast.makeText(HotelRegisterActivity.this, response, Toast.LENGTH_SHORT).show();
                    }
                }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(HotelRegisterActivity.this, error.toString(), Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
        ...
        Singleton.getInstance(HotelRegisterActivity.this).addToRequestque(stringRequest);
